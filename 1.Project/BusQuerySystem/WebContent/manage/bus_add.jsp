...
<body>
	<form name="form1" method="post" action="minsert.do">
		<table width="70%" border="0" align="center" cellpadding="0"
			cellspacing="0" class="border">
			<tr>
				<td colspan="2" align="center" valign="middle" bgcolor="#FF9999"
					class="td_right"><font size="+3"><strong>添加线路</strong></font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="td_right"><p>（站台间用“->”分隔，如“站点A->站点B”）</p>
					<label> <textarea name="route" id="route" cols="65"
							rows="12"></textarea>
				</label></td>
			</tr>
			<tr>
